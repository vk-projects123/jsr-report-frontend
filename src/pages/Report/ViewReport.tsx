    ...
    <>
      ...
      <div>
        ...
        <HeaderRow>
          ...
          <TitleContainer>
            <strong>In Process Inspection Report</strong>
          </TitleContainer>
          <ReportDetails>
        ...
        <Container id="report">
          ...
          <div className="content" style={{ height: isClick ? '151vh' : "" }}>
            ...
            <HeaderRow id="header" className="pdf-header">
              <LogoContainer style={{width:'250px',height:'100px'}}>
                <img src={pdflogo} alt="PDF Logo" />
              </LogoContainer>
              <TitleContainer>
                <strong className={isClick ? 'pdf-span' : ""}>In Process Inspection Report</strong>
              </TitleContainer>
              <ReportDetails style={{width:'250px',height:'100px'}}>
                <div>Report Date: 11/08/2020</div>
                <div>Report No: IPQC-0003</div>
              </ReportDetails>
            </HeaderRow>
            ...
            <div className="avoid-break" id="reportDetails">
              ...
              <Table>
                <tbody>
                  <tr>
                    <HeaderCell style={{width:'250px',height:'100px'}}><span><strong>OA No</strong></span></HeaderCell>
                    <TableCell style={{width:'250px',height:'100px'}}><span>9120200001</span></TableCell>
                    <HeaderCell style={{width:'250px',height:'100px'}}><span><strong>Date</strong></span></HeaderCell>
                    <TableCell style={{width:'250px',height:'100px'}}><span>11-Aug, 2020</span></TableCell>
                  </tr>
                  <tr>
          ...
          {/* header */}
          <div className="content" style={{ height: isClick ? '151vh' : "" }}>
            {isClick ? <HeaderRow id="header" className="pdf-header">
              <LogoContainer style={{width:'250px',height:'100px'}}>
                <img src={pdflogo} alt="PDF Logo" />
              </LogoContainer>
              <TitleContainer>
